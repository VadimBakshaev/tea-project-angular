...
import { SlideItemType } from '../../core/types/slide-item.type';
import { AccordionItemType } from '../../core/types/accordion-item.type';
...
export class MainComponent implements AfterViewInit, OnDestroy {
  private readonly modalDialog = inject(NgbModal);
